...
const ParticlesBackground = ({
  ...
  zIndex = 0,
  height = '100%',
  containerId = 'js-particles',
}) => {
  useLayoutEffect(() => {
    const script = document.createElement('script');
    script.src = "https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js";
    script.onload = () => {
      const particlesElement = document.getElementById(containerId);
  ...
  }, [colors, size, countDesktop, countTablet, countMobile, containerId]);
  ...
  return (
    ...
    >
      <style>{`
        ...
        #${containerId} .particles-js-canvas-el {
          position: absolute;
        }
      `}</style>
